...
class TYProgressBar: UIView {
    ...
    override init(frame: CGRect) {
        ...
        shapeLayer = createShapeLayer(strokeColor: #colorLiteral(red: 0.1764705882, green: 0.1450980392, blue: 0.06666666667, alpha: 0.7932083972), fillColor: .clear)
    ...
    override func layoutSubviews() {
        ...
        print("Radius", radius)
        let path = UIBezierPath(arcCenter: .zero, radius: radius, startAngle: (5 * CGFloat.pi) / 4, endAngle: (3 * CGFloat.pi) / 4, clockwise: true)
//        let a = UIBezierPath()
//        a.move(to: CGPoint(x: 0, y: cy))
//        a.addLine(to: CGPoint(x: self.bounds.width , y: cy))
